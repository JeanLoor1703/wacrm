...
export const DEFAULT_THEME: ThemeId = 'creacom';

export const STORAGE_KEY = 'creacom.crm.theme';
 ...
 * the CREACOM brand default; dark remains available as an option.
 *
...
export const MODE_STORAGE_KEY = 'creacom.crm.mode';
...
export const THEMES: ReadonlyArray<ThemeMeta> = [
  {
    id: 'creacom',
    name: 'CREACOM',
    tagline: 'Rojo técnico, grafito industrial y superficies de concreto.',
    swatch: '#ED3237',
  },
  {
    id: 'violet',
