    ...
    <>
      ...
      <aside
        className={cn(
          ...
          'border-border bg-sidebar fixed inset-y-0 left-0 z-40 flex h-full w-64 flex-col border-r shadow-[12px_0_32px_-28px_rgba(21,21,21,0.45)]',
      ...
      >
        ...
        <div className="border-border flex h-20 shrink-0 items-center justify-between gap-2 border-b px-4">
          <Link href="/dashboard" className="min-w-0 flex-1">
            <Image
              ...
              priority
            />
            <span className="border-primary font-heading text-muted-foreground mt-1 block border-l-2 pl-2 text-[9px] font-bold tracking-[0.18em] uppercase">
              {t('title')}
            </span>
          </Link>
          <button
                ...
                <li key={item.href}>
                  <Link
                    ...
                    className={cn(
                      ...
                      'relative flex items-center gap-3 rounded-md px-3 py-2.5 text-sm font-medium transition-colors lg:py-2',
                      isActive
                        ? 'bg-primary-soft text-primary before:bg-primary before:absolute before:top-2 before:bottom-2 before:left-0 before:w-0.5'
                  ...
                  >
                    ...
                    {item.beta && (
                      <span
                        aria-label={t('beta')}
                        className="border-primary/25 bg-primary-soft text-primary rounded-sm border px-1.5 py-0.5 text-[9px] font-semibold tracking-wider uppercase"
                      >
                        {t('beta')}
                      </span>
                    )}
        ...
        {/* User section */}
        <div className="border-primary/80 shrink-0 border-t-2 p-3">
