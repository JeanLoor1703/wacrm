...
export function Header({ onOpenSidebar }: HeaderProps) {
  ...
  return (
    <header className="border-border relative flex h-16 shrink-0 items-center justify-between gap-3 border-b bg-white px-4 shadow-[0_8px_28px_-26px_rgba(21,21,21,0.7)] lg:px-6">
      ...
      <div className="flex min-w-0 items-center gap-2">
        ...
        <div className="min-w-0">
          <p className="font-heading text-primary hidden text-[9px] font-bold tracking-[0.2em] uppercase sm:block">
            Sistema de ventas · Hormigón
          </p>
          <h1 className="font-heading text-foreground truncate text-base font-bold tracking-[0.03em] uppercase sm:text-lg">
